...
public class ItemServiceImpl implements ItemService{
	...
	public Item findById(Long id, Integer cantidad) {
		...
		Producto producto=clienteRest
				...
				.getForObject("http://servicio-productos/ver/{id}", Producto.class,pathVariable);
	...
	public Producto update(Producto producto, Long id) {
		...
		ResponseEntity<Producto> response=
				clienteRest.exchange("http://servicio-productos/editar/{id}", HttpMethod.PUT, body, Producto.class,pathVariable);
